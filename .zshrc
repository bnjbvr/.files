...
plugins=(git mercurial debian battery npm jump sudo vundle web-search)

source $ZSH/oh-my-zsh.sh

# User configuration

export PATH="/home/ben/.files:/home/ben/.files/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:~/usr/bin"
